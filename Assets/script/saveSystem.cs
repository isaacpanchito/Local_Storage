...
public class saveSystem : MonoBehaviour
{
    ...
    /*Iniciar variable string para guardar la ruta del archivo que guardara  todo*/
    string savePath;
    /* Esta variable se crea a partir de una clase creada "SaveData" */
    saveData data;

    public void Awake()  {
        /* En awake buscamos el obejeto de tipo script "nombre del script" */
        userscr=FindObjectOfType<guardarnombre>();
        problemascr=FindObjectOfType<InitialData>();
        /* Aqui asignamos la ruta */
        ...
        /* Aqui preguntamos si existe la ruta */
    ...
    void saveGame(saveData dataToSave){
        ...
        //Aqui asignamos a la variable JsonData la converison json de nuestra variable de tipo saveData
        File.WriteAllText(savePath, JsonData);
        //Con esto escribimos en el archivo local. Los parametros son(ruta del archivo, Valores)
    }
    ...
    saveData LoadGame(){
        ...
        //En una variable "leemos todo lo que este en el archivo". Los parametros de ReadAllText es (Ruta del archivo)
        saveData datatoReturn=JsonUtility.FromJson<saveData>(loadedData);
        //En una variable tipo saveData convertimos con Json todo el texto que habia
        return datatoReturn;
        //return nos regresa la variable y su valor/es
    }
    ...
    public void loadGameButton(){
        ...
        /* objetoScript|Metodo a llamar|(valor que enviamos) */
